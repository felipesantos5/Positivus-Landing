      ...
      <div className="ml-24 flex flex-col gap-10">
         ...
         <div className="grid grid-cols-2 gap-6">
            <div className="flex flex-col gap-10">
               <ServiceCard bgColor={"bg-grey"} title1={"Search engine"} title2={"optimization"} titleBg={"bg-green"} icon={ServiceCardImg.darkIcon} iconDescColor={"text-black"} imgService={ServiceCardImg.lupaService} widthImage={"w-72"} mrImage={"mr-12"} mtImage={"mt-72px"}></ServiceCard>
            ...
            <div className="flex flex-col gap-10">
               ...
               <ServiceCard bgColor={"bg-darkGrey"} title1={"Analytics and "} title2={"Tracking"} titleBg={"bg-green"} icon={ServiceCardImg.whiteIcon} iconDescColor={"text-white"} imgService={ServiceCardImg.analyticsService} widthImage={"w-60"} mrImage={"mr-12"} mtImage={"mt-72px"}></ServiceCard>
            </div>
         </div>
      </div>
   )
