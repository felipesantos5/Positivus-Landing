      ...
      <div>
         ...
         <div className="flex flex-col gap-10 mb-10">
            <div className="grid grid-cols-3 gap-10">
               ...
               widthDesc={"w-194"}></TeamCards>

               <TeamCards imgTeam={michael}
               name={"Michael Brown"}
               ...
               widthDesc={"w-183"}></TeamCards>
            </div>
            
            <div className="grid grid-cols-3 gap-10">
               <TeamCards imgTeam={emily}
               name={"Emily Johnson"}
               ...
               widthDesc={"w-114"}></TeamCards>

               <TeamCards imgTeam={brian}
               name={"Brian Williams"}
               nameDesc={"Social Media Specialist"}
               cardDesc={"4+ years of experience in social media marketing. Proficient in creating and scheduling content, analyzing metrics, and building engagement"} widthDesc={"w-194"}></TeamCards>

               <TeamCards imgTeam={sarah}
               name={"Sarah Kim"}
